...
namespace Org.BouncyCastle.Asn1
{
  using Encoding = System.Text.Encoding;
    ...
    public class DerGraphicString : DerStringBase
    {
        ...
        {
            if (obj == null || obj is DerGraphicString) { return (DerGraphicString)obj; }
        ...
        public static DerGraphicString GetInstance(Asn1TaggedObject obj, bool isExplicit)
        {
            ...
            if (isExplicit || o is DerGraphicString) { return GetInstance(o); }
        ...
        public override string GetString() { return Encoding.UTF8.GetString(mString); }
        public byte[] GetOctets() { return Arrays.Clone(mString); }

        internal override void Encode(DerOutputStream derOut)
        { derOut.WriteEncoded(Asn1Tags.GraphicString, mString); }

        protected override int Asn1GetHashCode() { return Arrays.GetHashCode(mString); }
