...
namespace Org.BouncyCastle.Asn1.X9
{
	public class DHPublicKey : Asn1Encodable
	{
		...
		{
			if (obj == null || obj is DHPublicKey) { return (DHPublicKey)obj; }

			if (obj is DerInteger) { return new DHPublicKey((DerInteger)obj); }
		...
		public DerInteger Y { get { return this.y; } }
		public override Asn1Object ToAsn1Object() { return this.y; }
	}
}