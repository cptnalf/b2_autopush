...
namespace Org.BouncyCastle.Asn1
{
    ...
    public class DerIA5String : DerStringBase
    {
        ...
        {
            if (obj == null || obj is DerIA5String) { return (DerIA5String)obj; }
        ...
        public static DerIA5String GetInstance( Asn1TaggedObject obj, bool isExplicit)
        {
			...
			if (isExplicit || o is DerIA5String) { return GetInstance(o); }
         ...
         */
        public DerIA5String( byte[] str) : this(Encoding.UTF8.GetString(str), false) { }
		...
		public DerIA5String( string	str, bool	validate) 
    {
		...
		public override string GetString() { return str; }
		public byte[] GetOctets() { return Encoding.UTF8.GetBytes(str); }

		internal override void Encode( DerOutputStream derOut) { derOut.WriteEncoded(Asn1Tags.IA5String, GetOctets()); }

		protected override int Asn1GetHashCode() { return this.str.GetHashCode(); }
