...
namespace Org.BouncyCastle.Asn1
{
    ...
    public class DerPrintableString : DerStringBase
    {
         ...
         */
        public DerPrintableString( byte[] str) : this(Encoding.UTF8.GetString(str), false) { }
		...
		*/
		...
		internal override void Encode( DerOutputStream derOut) { derOut.WriteEncoded(Asn1Tags.PrintableString, GetOctets()); }
