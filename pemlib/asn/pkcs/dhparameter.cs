...
namespace Org.BouncyCastle.Asn1.Pkcs
{
		...
		public DHParameter( BigInteger	p, BigInteger	g, int			l)
    {
      this.p = new DerInteger(p);
		...
		public BigInteger P { get { return p.PositiveValue; } }
		public BigInteger G { get { return g.PositiveValue; } }
		public BigInteger L { get { return l == null ? null : l.PositiveValue; } }

		public override Asn1Object ToAsn1Object()
    {
      Asn1EncodableVector v = new Asn1EncodableVector(p, g);

			if (this.l != null) { v.Add(l); }
