...
namespace Org.BouncyCastle.Security
{
    ...
    public sealed class MacUtilities
    {
        ...
        public static IMac GetMac( DerObjectIdentifier id) { return GetMac(id.Id); }
        public static IMac GetMac( string algorithm)
        {
            ...
            if (mechanism == null) { mechanism = upper; }
            ...
            if (mechanism == "AESCMAC") { return new CMac(new AesFastEngine()); }
            if (mechanism == "DESMAC") { return new CbcBlockCipherMac(new DesEngine()); }
            if (mechanism == "DESMAC/CFB8") { return new CfbBlockCipherMac(new DesEngine()); }
            if (mechanism == "DESMAC64") { return new CbcBlockCipherMac(new DesEngine(), 64); }
